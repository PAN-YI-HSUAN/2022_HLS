...
// ==============================================================
`timescale 1 ns / 1 ps
module dft_dft_Pipeline_VITIS_LOOP_10_1_sin_coefficients_table_ROM_AUTO_1R (
...
initial begin
    $readmemh("./dft_dft_Pipeline_VITIS_LOOP_10_1_sin_coefficients_table_ROM_AUTO_1R.dat", ram0);
    $readmemh("./dft_dft_Pipeline_VITIS_LOOP_10_1_sin_coefficients_table_ROM_AUTO_1R.dat", ram1);
    $readmemh("./dft_dft_Pipeline_VITIS_LOOP_10_1_sin_coefficients_table_ROM_AUTO_1R.dat", ram2);
    $readmemh("./dft_dft_Pipeline_VITIS_LOOP_10_1_sin_coefficients_table_ROM_AUTO_1R.dat", ram3);
end
