...
module dft_dft_Pipeline_VITIS_LOOP_21_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [8:0] n_2_reg_255;
reg   [8:0] n_2_reg_255_pp0_iter1_reg;
reg   [8:0] n_2_reg_255_pp0_iter2_reg;
wire   [0:0] icmp_ln21_fu_164_p2;
reg   [0:0] icmp_ln21_reg_261_pp0_iter1_reg;
reg   [0:0] icmp_ln21_reg_261_pp0_iter2_reg;
reg   [0:0] icmp_ln21_reg_261_pp0_iter3_reg;
wire   [31:0] zext_ln437_fu_185_p1;
reg   [63:0] x_assign_1_reg_270;
...
wire   [0:0] icmp_ln22_fu_204_p2;
reg   [0:0] icmp_ln22_reg_275;
reg   [0:0] icmp_ln22_reg_275_pp0_iter4_reg;
...
wire   [31:0] bitcast_ln26_fu_209_p1;
...
reg   [63:0] mul_reg_310;
wire   [63:0] select_ln26_fu_217_p3;
reg   [63:0] select_ln26_reg_315;
reg   [63:0] add1_reg_320;
...
wire   [63:0] n_2_cast3_fu_200_p1;
wire    ap_block_pp0_stage0;
reg   [7:0] phi_mul2_fu_66;
wire   [7:0] add_ln26_fu_179_p2;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_phi_mul2_load;
reg   [31:0] empty_fu_70;
wire    ap_block_pp0_stage1;
reg   [8:0] n_fu_74;
wire   [8:0] add_ln21_fu_170_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln21_reg_261 == 1'd0) & (1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln21_fu_164_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln21_reg_261 == 1'd0) & (1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        x_assign_1_reg_270 <= grp_fu_260_p_dout0;
    end
end

always @ (*) begin
    if (((icmp_ln21_reg_261 == 1'd1) & (1'b0 == ap_block_pp0_stage10_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln21_reg_261_pp0_iter3_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln21_reg_261_pp0_iter3_reg == 1'd1))) begin
        p_out_ap_vld = 1'b1;
    end else begin
        p_out_ap_vld = 1'b0;
    end
...
assign add_ln21_fu_170_p2 = (ap_sig_allocacmp_n_2 + 9'd1);

assign add_ln26_fu_179_p2 = (ap_sig_allocacmp_phi_mul2_load + trunc_ln18_1);
...
assign bitcast_ln26_fu_209_p1 = real_sample_load_reg_285;

assign grp_fu_246_p_ce = 1'b1;

assign grp_fu_246_p_din0 = add1_reg_320;
...
assign grp_fu_252_p_din0 = select_ln26_reg_315;

assign grp_fu_252_p_din1 = mul_reg_310;

assign grp_fu_252_p_opcode = 2'd0;

assign grp_fu_256_p_ce = 1'b1;

assign grp_fu_256_p_din0 = conv2_reg_295;

assign grp_fu_256_p_din1 = tmp_3_reg_300;

assign grp_fu_260_p_ce = 1'b1;

assign grp_fu_260_p_din0 = zext_ln437_fu_185_p1;

assign grp_sin_or_cos_double_s_fu_110_ap_ready = grp_sin_or_cos_double_s_fu_263_p_ready;

assign grp_sin_or_cos_double_s_fu_263_p_din1 = x_assign_1_reg_270;

assign grp_sin_or_cos_double_s_fu_263_p_din2 = 1'd0;

assign grp_sin_or_cos_double_s_fu_263_p_start = grp_sin_or_cos_double_s_fu_110_ap_start_reg;

assign icmp_ln21_fu_164_p2 = ((ap_sig_allocacmp_n_2 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln22_fu_204_p2 = ((n_2_reg_255_pp0_iter2_reg == 9'd0) ? 1'b1 : 1'b0);

assign n_2_cast3_fu_200_p1 = n_2_reg_255_pp0_iter2_reg;

assign p_out = empty_fu_70;

assign real_sample_address0 = n_2_cast3_fu_200_p1;

assign select_ln26_fu_217_p3 = ((icmp_ln22_reg_275_pp0_iter4_reg[0:0] == 1'b1) ? 64'd0 : grp_fu_249_p_dout0);

assign zext_ln437_fu_185_p1 = ap_sig_allocacmp_phi_mul2_load;

endmodule //dft_dft_Pipeline_VITIS_LOOP_21_3
