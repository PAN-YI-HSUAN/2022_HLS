set moduleName dut_Pipeline_Store_vertice_loop
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dut_Pipeline_Store_vertice_loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 0}  }
	{ sext_ln145 int 62 regular  }
	{ add int 32 regular  }
	{ numVert int 32 regular  }
	{ offset_buf int 16 regular {array 3534 { 0 3 } 0 1 } {global 1}  }
	{ btwn_buf float 32 regular {array 3534 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "offset","offset": { "type": "dynamic","port_name": "offset","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln145", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "add", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "numVert", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "offset_buf", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "btwn_buf", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ sext_ln145 sc_in sc_lv 62 signal 1 } 
	{ add sc_in sc_lv 32 signal 2 } 
	{ numVert sc_in sc_lv 32 signal 3 } 
	{ offset_buf_address0 sc_out sc_lv 12 signal 4 } 
	{ offset_buf_ce0 sc_out sc_logic 1 signal 4 } 
	{ offset_buf_we0 sc_out sc_logic 1 signal 4 } 
	{ offset_buf_d0 sc_out sc_lv 16 signal 4 } 
	{ btwn_buf_address0 sc_out sc_lv 12 signal 5 } 
	{ btwn_buf_ce0 sc_out sc_logic 1 signal 5 } 
	{ btwn_buf_we0 sc_out sc_logic 1 signal 5 } 
	{ btwn_buf_d0 sc_out sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln145", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln145", "role": "default" }} , 
 	...
 	{ "name": "offset_buf_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "offset_buf", "role": "we0" }} , 
 	{ "name": "offset_buf_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "offset_buf", "role": "d0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3538", "Max" : "3538"}
	, {"Name" : "Interval", "Min" : "3538", "Max" : "3538"}
]}
